class Conversation {
  ...
  factory Conversation.fromMap(Map<String, dynamic> map, String currentUserId, Map<String, dynamic> otherProfile) {
    final isUser1 = map['user1_id'] == currentUserId;
    final otherUser = isUser1 ? map['user2_id'] : map['user1_id'];
